...
- **Verify against the Stripe dashboard** (pending): cancel → "cancels at period end"; delete → subscription Canceled + customer retained + no further charges. **No Stripe webhook handler exists** — noted as a future robustness item.
