 ...
 *
 * Pence, integer. Money in a float is how £14.99 becomes £14.989999999999998.
 *
 * ⚠️ site/lib/price.ts is this file, twice. The three apps share no code —
...
/** What a model sees. null when the stylist has not said. */
...
export function poundsToPence(
  input: string,
): { ok: true; pence: number | null } | { ok: false; error: string } {
