 ...
 * An identical copy lives at `mobile/src/lib/reportReasons.ts`. The three apps have
 ...
 *
 * Change a code here and you must change it in `mobile/src/lib/reportReasons.ts` and
